...
func +(c: Complex, x: Float) -> Complex {
    let y = Complex(real: x, imag: 0.0)
    return Complex.add(c1: c, to: y)
}
...
func -(c: Complex, x: Float) -> Complex {
    let y = Complex(real: x, imag: 0.0)
    return Complex.subtract(c1: c, from: y)
}
...
func *(c: Complex, x: Float) -> Complex {
    let y = Complex(real: x, imag: 0.0)
    return Complex.multiply(c1: c, by: y)
}
...
func /(c: Complex, x: Float) -> Complex {
    let y = Complex(real: x, imag: 0.0)
    return Complex.divide(c1: c, by: y)
}
